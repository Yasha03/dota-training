<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            <form class="login100-form validate-form" action="/account/register" method="post">
                <span class="login100-form-title p-b-26">
                    РЕГИСТРАЦИЯ
                </span>
                <span class="login100-form-title p-b-48">
                    <img src="/public/login-data/images/dota-logo-png-png-image-715135.png" style="width: 100px">
                ...
                <!--<div class="g-recaptcha" id="g-recaptcha" data-sitekey="6Le3B_kUAAAAAP2gJBnJpSjzMdkc5TXYfjgd2GQf"></div>-->
